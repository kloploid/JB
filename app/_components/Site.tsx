...
const SALES: Record<Lang, Copy> = {
  en: {
    ...
    heroEyebrow: "Massage in Tallinn",
    heroTitle: "Relief that lasts long after the session.",
    heroSub:
      "Individual bodywork that releases muscle tension, restores freedom of movement, and helps your body recover naturally.",
    ...
    outcomeDesc: [
      "Targeted bodywork designed to relieve chronic tension and strain in the back, neck, and shoulder area.",
      "Massage helps relax muscles, improve flexibility, and reduce fatigue after intense training sessions, supporting faster and more efficient recovery.",
  ...
  ru: {
    ...
    heroEyebrow: "Массаж в Таллинне",
    heroTitle: "Облегчение, которое чувствуется ещё долго после сеанса.",
    heroSub:
      "Индивидуальная работа с телом: снимаем мышечное напряжение, возвращаем свободу движения и помогаем организму восстановиться естественно.",
    ctaBook: "Записаться",
    ...
    outcomeDesc: [
      ...
      "Массаж способствует расслаблению мышц, улучшению их эластичности и снижению чувства усталости после интенсивных тренировок.",
  ...
  et: {
    ...
    heroEyebrow: "Massaaž Tallinnas",
    heroTitle: "Kergendus, mida tunned veel kaua pärast seanssi.",
    heroSub:
      "Individuaalne kehatöö, mis vabastab lihaspingeid, taastab liikumisvabaduse ja aitab kehal loomulikul viisil taastuda.",
    ...
    outcomeDesc: [
      "Sihtotstarbeline kehatöö kroonilise pinge ja ülekoormuse leevendamiseks selja-, kaela- ja õlavöötme piirkonnas.",
      "Massaaž aitab lõõgastada lihaseid, parandada nende elastsust ning vähendada väsimustunnet pärast intensiivseid treeninguid, toetades kiiremat ja tõhusamat taastumist.",
